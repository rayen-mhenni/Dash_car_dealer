...
import AddOrUpdateModalGestion from "../components/Models/AddOrUpdateModalGestion";
...
function Gestion() {
  ...
  useEffect(() => {
    axios.get("https://www.portalite.fr/api/gestion", config).then((response) => {
      if (response.data) {
  ...
  const handleDelete = async (id) => {
    ...
    await axios
      .delete(`https://www.portalite.fr/api/gestion/delete/${id}`, config)
